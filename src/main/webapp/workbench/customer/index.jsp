...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载时，从后台查询数据，返回查询列表，并完成分页操作
		pageList(1,2);

		//第二个查询入口，为查询按钮绑定事件
		$("#selectBtn").click(function (){

			//当点击查询按钮的时候，将查询的数据暂时存放到隐藏域中
	...
	function pageList(pageNo,pageSize){
		...
		//当执行分页操作的时候，就将隐藏域中的数据取出来，在放到搜索框中
